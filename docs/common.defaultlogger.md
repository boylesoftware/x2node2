...
Also, this implementation can be used as a base class for another logger service implementation. The extended class can override [writeMessage()](./common.defaultlogger.writemessage.md) method to provide its own logic for writing log messages.
